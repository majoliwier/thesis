...
#define SW_CS_PORT    GPIOC
#define SW_CS_PIN     GPIO_PIN_4
...
void MAX30003_Init(MAX30003_Ctx *c, SPI_HandleTypeDef *hspi, GPIO_TypeDef *port, uint16_t pin) {
    ...
    MAX30003_WriteReg(c, 0x00, 0x000000);
    MAX30003_WriteReg(c, 0x09, 0x000000);
